...
<html lang="fr">
  ...
  <body style="background-color:#1B2631; color:white;">
    <div class="container text-end">
      <br>
      <a href="../index.php" type="button" class="btn btn-outline-light">Retour</a>
    </div>
                ...
                foreach ($lesFactures as $uneFacture){
                    ...
                    <div class="shadow-none p-3 mb-5 rounded" style="background-color:#34495E">
                        ...
                        <div class="text-center">
                            ...
                            <a href="suppFactureEtape1.php?numFacture=<?php echo $uneFacture['num_facture'];?>"type="button" class="btn btn-outline-danger">Supprimer</a>
                        </div>
